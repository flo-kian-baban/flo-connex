...
export default function FeaturesOrbit({
    heading = <>Create more. <br /></>,
    subHeading = "Admin less.",
    description = "Spend your time creating content, not managing emails or contracts.",
    feature1 = { title: "Match Your Value", desc: "Unlock services and experiences that align with your lifestyle. No cash-flow needed.", cardLabel: "Offer Accepted" },
    feature2 = { title: "Verified Businesses", desc: "Partner with real, local businesses that understand and value creator marketing." },
    feature3 = { title: "Direct Chat", desc: "Speak directly with the decision maker. Clear terms, no middlemen." },
    feature4 = { title: "Clear Deliverables", desc: "Know exactly what's expected before you start. No scope creep." }
}: FeaturesOrbitProps) {
    return (
        <section className="relative py-24 md:py-32 overflow-hidden bg-white">
            ...
            <div className="max-w-7xl mx-auto px-4 md:px-8">
                ...
                {/* Header */}
                <div className="text-center max-w-3xl mx-auto mb-20 md:mb-14">
                    <ScrollReveal>
                ...
                <div className="grid grid-cols-1 md:grid-cols-6 gap-8 min-h-[600px]">
                    ...
                    <ScrollReveal className="md:col-span-4 h-full" delay={200}>
                        <div className="h-full rounded-[2.5rem] p-8 md:p-14 border shadow-sm hover:shadow-xl transition-all duration-500 relative overflow-hidden group flex flex-col justify-between hover:-translate-y-1 bg-white border-gray-100">
                            <div className="relative z-10 max-w-md">
                                <div className="w-16 h-16 bg-orange-50 rounded-2xl flex items-center justify-center text-primary mb-8 transition-transform group-hover:scale-110 duration-500">
                                    <Zap size={32} />
                                </div>
                                <h3 className="text-3xl font-bold mb-4 tracking-tight text-gray-900">{feature1.title}</h3>
                                <p className="text-lg leading-relaxed text-gray-500">{feature1.desc}</p>
                            </div>
                            ...
                            <div className="absolute top-1/2 -right-12 -translate-y-1/2 w-96 h-full hidden md:flex items-center justify-center opacity-40 group-hover:opacity-100 transition-all duration-700 group-hover:translate-x-0 translate-x-12">
                                <div className="relative w-full h-80">
                                    {/* Back card */}
                                    <div className="absolute top-0 right-12 border shadow-[0_8px_30px_rgb(0,0,0,0.06)] rounded-2xl p-4 w-64 rotate-6 transform transition-transform group-hover:rotate-12 duration-700 bg-white border-gray-100">
                                    ...
                                    {/* Front Match Card */}
                                    <div className="absolute top-20 right-20 border shadow-[0_8px_40px_rgb(0,0,0,0.08)] rounded-2xl p-5 w-72 -rotate-3 border-l-4 border-l-primary z-10 transform transition-transform group-hover:-rotate-6 duration-700 bg-white border-green-100">
                    ...
                    <ScrollReveal className="md:col-span-2 h-full" delay={500}>
                        <div className="h-full bg-white rounded-[2.5rem] p-8 md:p-12 border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-500 group overflow-hidden relative hover:-translate-y-1">
                            <div className="relative z-10">
                                <div className="w-16 h-16 bg-orange-50 rounded-2xl flex items-center justify-center text-primary mb-8 transition-transform group-hover:scale-110 duration-500">
                                    <Zap size={32} />
                                </div>
                                <h3 className="text-2xl font-bold mb-3 tracking-tight text-gray-900">{feature4.title}</h3>
                                <p className="text-lg leading-relaxed text-gray-500">{feature4.desc}</p>
                            </div>
