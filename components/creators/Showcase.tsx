...
export default function Showcase() {
    ...
    return (
        <section className="relative py-24 md:py-16 overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 md:px-8">
                ...
                <div className="flex flex-col md:flex-row justify-between items-center md:items-center gap-8 mb-16 md:mb-16">
                    <ScrollReveal>
                        <div>
                            <h2 className="text-4xl md:text-5xl font-bold mb-4 tracking-tight text-gray-900">Recent Exchanges</h2>
                            <p className="text-lg md:text-xl leading-relaxed max-w-xl text-gray-500">Real experiences unlocked by Connex creators.</p>
                        </div>
                    </ScrollReveal>
                    ...
                    <ScrollReveal delay={200} direction="right">
                        <div className="flex gap-4">
                            <button
                                onClick={scrollPrev}
                                className="w-14 h-14 rounded-full border border-gray-200 flex items-center justify-center bg-white hover:shadow-xl hover:border-primary/20 transition-all text-gray-600 active:scale-95 group"
                            >
                                <ArrowLeft size={24} className="group-hover:-translate-x-1 transition-transform" />
                            </button>
                            <button
                                onClick={scrollNext}
                                className="w-14 h-14 rounded-full bg-gray-900 text-white flex items-center justify-center hover:bg-primary shadow-lg hover:shadow-primary/30 transition-all active:scale-95 group"
                            >
